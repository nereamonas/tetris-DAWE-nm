...
const { JSDOM } = jsdom;
let dom = new JSDOM('<!DOCTYPE html><head><script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js" type="text/javascript"></script><title></title></head><body><canvas id="canvas" width="302" height="150"></canvas></body>');
