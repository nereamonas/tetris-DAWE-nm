...
const { JSDOM } = jsdom;
let dom = new JSDOM('<!DOCTYPE html><head><script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js" type="text/javascript"></script><title></title></head><body><canvas id="canvas" width="300" height="600"></canvas></body>');
...
QUnit.module('EJERCICIO 8.1', function() {
    ...
    QUnit.test('Testeando la rotación', function(assert) {
        ...
        //assert.equal(!game.current_shape.can_rotate(game.board),false);
